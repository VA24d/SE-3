...
Listen address: set SYNCSPACE_HOST=0.0.0.0 to accept connections from other devices on
your LAN (then open http://<this-machine-LAN-IP>:8080/ on them). Default is 127.0.0.1.
"""
import logging
import os
