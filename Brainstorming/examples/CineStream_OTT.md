# Project Description — CineStream Platform (OTT)
...
- At any point one user should be streaming content from only one platform (e.g., same user cannot login from multiple devices and use multiple platforms)
...
- The system should provide easy means for admins/maintenance team to get access to the different analytics with respect to platform use like number of users, response time, server utilization, throughput, etc.
...
- Architecture diagram(s) — You can make use of UML (Component, Use Case, Sequence, Deployment if necessary) or C4 Model (Context, Container and Component)

### Task 4: Architecture Analysis

- Perform a simple implementation of a part of the system with this architecture and compare it with one other pattern of your choice, provide some quantification of at least 2 of the NFRs that you have considered (e.g., response time, throughput, utilization, etc.). What do you have to say about trade-offs?
